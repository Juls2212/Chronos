...
const controlButtonElements = document.querySelectorAll("[data-clock-action]");
...
async function refreshInterface() {
    await Promise.all([refreshClockState(), refreshHistory()]);
}
...
controlButtonElements.forEach((buttonElement) => {
